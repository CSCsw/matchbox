...
#ifndef LST_ITM_AND_VAL_IDXD_MAX_PRI_QUE_H
#define LST_ITM_AND_VAL_IDXD_MAX_PRI_QUE_H
...
class LstItmAndValIdxdMaxPriQue {
public:
  explicit LstItmAndValIdxdMaxPriQue(Size maxSize = 0): mMaxSize(maxSize),
      mSize(0), mItArr(NULL) {
...
#endif // LST_ITM_AND_VAL_IDXD_MAX_PRI_QUE_H
