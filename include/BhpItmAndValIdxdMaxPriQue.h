...
#ifndef BHP_ITM_AND_VAL_IDXD_MAX_PRI_QUE_H
#define BHP_ITM_AND_VAL_IDXD_MAX_PRI_QUE_H
...
class BhpItmAndValIdxdMaxPriQue {
public:
  explicit BhpItmAndValIdxdMaxPriQue(Size maxSize = 0): mMaxSize(maxSize),
...
#endif // BHP_ITM_AND_VAL_IDXD_MAX_PRI_QUE_H
