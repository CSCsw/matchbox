...
int main(int argc, char** argv) {
  ...
  // compute a Scaling 1-eps approx vertex weighted matching.
  cout << "[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[" << endl;
  cout << "computing matching ..." << endl;
  timer.Start();
  matchingEngine.ScaleOneMinusEpsVtxWght(graph, &mateVec, &card, &vtxWght,1.0/k);
  timer.Stop();
