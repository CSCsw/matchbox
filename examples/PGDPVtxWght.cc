...
int main(int argc, char** argv) {
  ...
  cout << "done reading weights file" << endl;
  ...
  // compute a path growing (with dynamic programming) 1/2-approx vertex weighted matching.
  cout << "[[[[[[[[[[[[[[[[[[[[[[PGDP[[[[[[[[[[[[[[[[[[[[[[[[[[[[" << endl;
  cout << "computing matching ..." << endl;
  timer.Start();
  matchingEngine.PGDPVtxWght(graph, &mateVec, &card, &vtxWght);
  timer.Stop();
